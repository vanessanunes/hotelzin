...
func CustomerRepository(db *sql.DB) *Customer {
	return &Customer{db}
}

func (repo Customer) InsertCustomer(customer models.Customer) (id int64, err error) {
...
func (repo Customer) GetCustomer(id int64) (customer models.Customer, err error) {
...
func (repo Customer) GetAllCustomer() (customers []models.Customer, err error) {
...
func (repo Customer) UpdateCustomer(id int64, customer models.Customer) (int64, error) {
...
func (repo Customer) DeleteCustomer(id int64) (int64, error) {
